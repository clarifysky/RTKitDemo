...
//        self.messageLabel?.attributedText = (message as! ChatTextMessage).attrText!
...
//        var x = self.imageViewAvatar!.frame.origin.x + (self.message!.ownerType == .Mine ? -self.messageLabel!.frame.width - 27 : self.imageViewAvatar!.frame.width + 23)
